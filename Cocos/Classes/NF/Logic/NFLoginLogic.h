...
#ifndef NF_LOGINLOGIC_H
#define NF_LOGINLOGIC_H
...
class NFLoginLogic
    : public NFLogicBase, public NFSingleton<NFLoginLogic>
{
public:
	NFLoginLogic() {};
	virtual ~NFLoginLogic() {};
    NFLoginLogic(NFIPluginManager* p)
    {
        pPluginManager = p;
    }
...
#define g_pLoginLogic (NFLoginLogic::Instance())
